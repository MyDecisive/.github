...
SmartHub is for MyDecisive power users. Try Octant before you roll your own SmartHub(s). 
...
* SmartHub configs
* OpenTelemetry configs and policies
* Notes from trying SmartHub solutions with a vendor or workflow
* Small fixes, docs, or improvements
* End-to-end examples others can learn from
